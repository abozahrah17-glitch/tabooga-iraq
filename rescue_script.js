...
// secondFunc is the duplicated original openProProfile
const secondFunc = js.indexOf('window.openProProfile = function(proId)', startIndex + 10);
// nextWindow is window.openSubmitRequest which originally followed openProProfile
const nextWindow = js.indexOf('window.openSubmitRequest = function()', secondFunc);
...
const cleanBefore = js.substring(0, startIndex);
const cleanAfter = js.substring(nextWindow);

js = cleanBefore + newLogic + cleanAfter;

fs.writeFileSync('script.js', js, 'utf8');
console.log("Restored script.js successfully. Length:", js.length);
